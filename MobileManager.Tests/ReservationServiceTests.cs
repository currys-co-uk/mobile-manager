...
namespace MobileManagerTests
{
    public class ReservationServiceTests
    {
        ...
        public async void LockSingleDeviceAsync()
        {
            ...
            mockHttp.When(HttpMethod.Put, $"{_httpLocalhost}/api/v1/device/{_device1.Id}").Respond("application/json", JsonConvert.SerializeObject(lockedDevice));
            mockHttp.When(HttpMethod.Get, $"{_httpLocalhost}/api/v1/device/{_device1.Id}").Respond("application/json", JsonConvert.SerializeObject(_device1));
        ...
        public async void UnlockSingleDeviceAsync()
        {
            ...
            var mockHttp = new MockHttpMessageHandler();
            mockHttp.When(HttpMethod.Put, $"{_httpLocalhost}/api/v1/device/{_device1.Id}").Respond("application/json", JsonConvert.SerializeObject(unlockedDevice));
            mockHttp.When(HttpMethod.Get, $"{_httpLocalhost}/api/v1/device/{_device1.Id}").Respond("application/json", JsonConvert.SerializeObject(_device1));
        ...
        public async void FindMatchingDevice_byDeviceType_iOSAsync()
        {
            ...
            var mockHttp = new MockHttpMessageHandler();
            mockHttp.When(HttpMethod.Get, $"{_httpLocalhost}/api/v1/device").Respond("application/json", JsonConvert.SerializeObject(new List<Device> { _device1, _device2 }));
