...
namespace MobileManagerTests
{
    ...
    {
        private static readonly Device Device1 = new DeviceFactory().NewDevice("111", "device_111", true, DeviceType.IOS, DeviceStatus.Online);
        private static readonly Device Device2 = new DeviceFactory().NewDevice("222", "device_222", true, DeviceType.Android, DeviceStatus.Online);
        ...
        public ReservationAppliedControllerTests()
        {
            ...
            _appiumService = new AppiumService(_config.Object, Logger);
        ...
        public void GetAllAppliedReservations()
        {
            ...
            var controller = new ReservationsAppliedController(mockRepository.Object, _restClient, _appiumService, Logger);
        ...
        public async void DeleteAppliedReservationAsync()
        {
            ...
            mockHttp.When(HttpMethod.Put, $"{_httpLocalhost}/api/v1/device/{Device1.Id}").Respond("application/json", JsonConvert.SerializeObject(unlockedDevice));
            mockHttp.When(HttpMethod.Get, $"{_httpLocalhost}/api/v1/device/{Device1.Id}").Respond("application/json", JsonConvert.SerializeObject(Device1));
            ...
            var controller = new ReservationsAppliedController(mockRepository.Object, new RestClient(_config.Object, new HttpClient(mockHttp), Logger), mockAppiumService.Object, Logger);
        ...
        public async void DeleteAppliedReservationAsync_failed_to_unlock_device()
        {
            ...
            var controller = new ReservationsAppliedController(mockRepository.Object, new RestClient(_config.Object, new HttpClient(mockHttp), Logger), _appiumService, Logger);
